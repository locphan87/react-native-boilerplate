...
To learn how to structure your application and use the Redux application architecture, read **[Code structure principles](docs/STRUCTURE.md)** for more details.
